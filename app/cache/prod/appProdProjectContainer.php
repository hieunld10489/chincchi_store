...
class appProdProjectContainer extends Container
{
    ...
    public function __construct()
    {
        ...
        $this->methodMap = array(
            ...
            'common_service' => 'getCommonServiceService',
            ...
            'doctrine.dbal.select_only_connection' => 'getDoctrine_Dbal_SelectOnlyConnectionService',
            ...
            'doctrine.orm.select_only_entity_listener_resolver' => 'getDoctrine_Orm_SelectOnlyEntityListenerResolverService',
            'doctrine.orm.select_only_entity_manager' => 'getDoctrine_Orm_SelectOnlyEntityManagerService',
            'doctrine.orm.select_only_manager_configurator' => 'getDoctrine_Orm_SelectOnlyManagerConfiguratorService',
            'doctrine.orm.validator.unique' => 'getDoctrine_Orm_Validator_UniqueService',
            'doctrine.orm.validator_initializer' => 'getDoctrine_Orm_ValidatorInitializerService',
            'doctrine_cache.providers.doctrine.orm.default_metadata_cache' => 'getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService',
            'doctrine_cache.providers.doctrine.orm.default_query_cache' => 'getDoctrineCache_Providers_Doctrine_Orm_DefaultQueryCacheService',
            'doctrine_cache.providers.doctrine.orm.default_result_cache' => 'getDoctrineCache_Providers_Doctrine_Orm_DefaultResultCacheService',
            'doctrine_cache.providers.doctrine.orm.select_only_metadata_cache' => 'getDoctrineCache_Providers_Doctrine_Orm_SelectOnlyMetadataCacheService',
            'doctrine_cache.providers.doctrine.orm.select_only_query_cache' => 'getDoctrineCache_Providers_Doctrine_Orm_SelectOnlyQueryCacheService',
            'doctrine_cache.providers.doctrine.orm.select_only_result_cache' => 'getDoctrineCache_Providers_Doctrine_Orm_SelectOnlyResultCacheService',
            'doctrine_event_listener' => 'getDoctrineEventListenerService',
            'entity_service' => 'getEntityServiceService',
            'event_dispatcher' => 'getEventDispatcherService',
            'file_locator' => 'getFileLocatorService',
            'filesystem' => 'getFilesystemService',
            'filter_controller_listener' => 'getFilterControllerListenerService',
            ...
            'sof.twig.sof_extension' => 'getSof_Twig_SofExtensionService',
        ...
        $this->aliases = array(
            ...
            'doctrine.orm.select_only_metadata_cache' => 'doctrine_cache.providers.doctrine.orm.select_only_metadata_cache',
            'doctrine.orm.select_only_query_cache' => 'doctrine_cache.providers.doctrine.orm.select_only_query_cache',
            'doctrine.orm.select_only_result_cache' => 'doctrine_cache.providers.doctrine.orm.select_only_result_cache',
    ...
    {
        return $this->services['common_service'] = new \Sof\ApiBundle\Controller\CommonFunc\CommonService($this->get('entity_service'));
    }
    ...
    {
        return $this->services['doctrine'] = new \Doctrine\Bundle\DoctrineBundle\Registry($this, array('select_only' => 'doctrine.dbal.select_only_connection', 'default' => 'doctrine.dbal.default_connection'), array('select_only' => 'doctrine.orm.select_only_entity_manager', 'default' => 'doctrine.orm.default_entity_manager'), 'default', 'default');
    }
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        $a->addEventListener(array(0 => 'prePersist', 1 => 'preUpdate'), $this->get('doctrine_event_listener'));
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_mysql', 'host' => 'localhost', 'port' => 3306, 'dbname' => 'chincchi_store', 'user' => 'chincchi_user', 'password' => 'admin123', 'charset' => 'UTF8', 'driverOptions' => array()), new \Doctrine\DBAL\Configuration(), $a, array());
    }
    protected function getDoctrine_Dbal_SelectOnlyConnectionService()
    {
        $a = new \Symfony\Bridge\Doctrine\ContainerAwareEventManager($this);
        $a->addEventListener(array(0 => 'prePersist', 1 => 'preUpdate'), $this->get('doctrine_event_listener'));
        return $this->services['doctrine.dbal.select_only_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_mysql', 'host' => 'localhost', 'port' => 3306, 'dbname' => 'chincchi_store', 'user' => 'chincchi_user', 'password' => 'admin123', 'charset' => 'UTF8', 'driverOptions' => array()), new \Doctrine\DBAL\Configuration(), $a, array());
    }
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService()
    {
        ...
        $a->addDriver(new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($this->get('annotation_reader'), array(0 => ($this->targetDirs[3].'/src/Sof/ApiBundle/Entity'))), 'Sof\\ApiBundle\\Entity');
        $b = new \Doctrine\ORM\Configuration();
        $b->setEntityNamespaces(array('SofApiBundle' => 'Sof\\ApiBundle\\Entity'));
        ...
        $b->addCustomStringFunction('time', 'Sof\\ApiBundle\\DQL\\MysqlTime');
        $b->addCustomStringFunction('date', 'Sof\\ApiBundle\\DQL\\MysqlDate');
        $b->addCustomStringFunction('date_format', 'Sof\\ApiBundle\\DQL\\MysqlDateFormat');
    ...
    protected function getDoctrine_Orm_SelectOnlyEntityListenerResolverService()
    {
        return $this->services['doctrine.orm.select_only_entity_listener_resolver'] = new \Doctrine\ORM\Mapping\DefaultEntityListenerResolver();
    }
    protected function getDoctrine_Orm_SelectOnlyEntityManagerService()
    {
        $a = new \Doctrine\Common\Persistence\Mapping\Driver\MappingDriverChain();
        $a->addDriver(new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($this->get('annotation_reader'), array(0 => ($this->targetDirs[3].'/src/Sof/ApiBundle/Entity'))), 'Sof\\ApiBundle\\Entity');
        $b = new \Doctrine\ORM\Configuration();
        $b->setEntityNamespaces(array('SofApiBundle' => 'Sof\\ApiBundle\\Entity'));
        $b->setMetadataCacheImpl($this->get('doctrine_cache.providers.doctrine.orm.select_only_metadata_cache'));
        $b->setQueryCacheImpl($this->get('doctrine_cache.providers.doctrine.orm.select_only_query_cache'));
        $b->setResultCacheImpl($this->get('doctrine_cache.providers.doctrine.orm.select_only_result_cache'));
        $b->setMetadataDriverImpl($a);
        $b->setProxyDir((__DIR__.'/doctrine/orm/Proxies'));
        $b->setProxyNamespace('Proxies');
        $b->setAutoGenerateProxyClasses(false);
        ...
        $b->setDefaultRepositoryClassName('Doctrine\\ORM\\EntityRepository');
        $b->setNamingStrategy($this->get('doctrine.orm.naming_strategy.default'));
        $b->setEntityListenerResolver($this->get('doctrine.orm.select_only_entity_listener_resolver'));
        $b->addCustomStringFunction('time', 'Sof\\ApiBundle\\DQL\\MysqlTime');
        $b->addCustomStringFunction('date', 'Sof\\ApiBundle\\DQL\\MysqlDate');
        $b->addCustomStringFunction('date_format', 'Sof\\ApiBundle\\DQL\\MysqlDateFormat');
        $this->services['doctrine.orm.select_only_entity_manager'] = $instance = \Doctrine\ORM\EntityManager::create($this->get('doctrine.dbal.select_only_connection'), $b);
        $this->get('doctrine.orm.select_only_manager_configurator')->configure($instance);
        return $instance;
    }
    protected function getDoctrine_Orm_SelectOnlyManagerConfiguratorService()
    {
        return $this->services['doctrine.orm.select_only_manager_configurator'] = new \Doctrine\Bundle\DoctrineBundle\ManagerConfigurator(array(), array());
    }
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_default_42dde6034e128a0cbfb89bf06b9792ed582cd03c8c23971922b28068c94836d3');
        return $instance;
    }
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_SelectOnlyMetadataCacheService()
    {
        $this->services['doctrine_cache.providers.doctrine.orm.select_only_metadata_cache'] = $instance = new \Doctrine\Common\Cache\ArrayCache();
        $instance->setNamespace('sf2orm_select_only_42dde6034e128a0cbfb89bf06b9792ed582cd03c8c23971922b28068c94836d3');
        return $instance;
    }
    protected function getDoctrineCache_Providers_Doctrine_Orm_SelectOnlyQueryCacheService()
    {
        $this->services['doctrine_cache.providers.doctrine.orm.select_only_query_cache'] = $instance = new \Doctrine\Common\Cache\ArrayCache();
        $instance->setNamespace('sf2orm_select_only_42dde6034e128a0cbfb89bf06b9792ed582cd03c8c23971922b28068c94836d3');
        return $instance;
    }
    protected function getDoctrineCache_Providers_Doctrine_Orm_SelectOnlyResultCacheService()
    {
        $this->services['doctrine_cache.providers.doctrine.orm.select_only_result_cache'] = $instance = new \Doctrine\Common\Cache\ArrayCache();
        $instance->setNamespace('sf2orm_select_only_42dde6034e128a0cbfb89bf06b9792ed582cd03c8c23971922b28068c94836d3');
        return $instance;
    }
    protected function getDoctrineEventListenerService()
    {
        return $this->services['doctrine_event_listener'] = new \Sof\ApiBundle\EventListener\DoctrineEventListener($this);
    }
    protected function getEntityServiceService()
    {
        return $this->services['entity_service'] = new \Sof\ApiBundle\Service\EntityService($this->get('doctrine'), $this->get('doctrine.orm.default_entity_manager'));
    }
    protected function getEventDispatcherService()
    {
        $this->services['event_dispatcher'] = $instance = new \Symfony\Component\EventDispatcher\ContainerAwareEventDispatcher($this);
        $instance->addListenerService('kernel.controller', array(0 => 'filter_controller_listener', 1 => 'onKernelController'), 0);
        $instance->addListenerService('kernel.exception', array(0 => 'filter_controller_listener', 1 => 'onKernelException'), 0);
    ...
    protected function getFilterControllerListenerService()
    {
        return $this->services['filter_controller_listener'] = new \Sof\ApiBundle\EventListener\FilterControllerListener();
    }
    ...
    {
        return $this->services['locale_listener'] = new \Symfony\Component\HttpKernel\EventListener\LocaleListener('vi_VN.UTF-8', $this->get('router', ContainerInterface::NULL_ON_INVALID_REFERENCE), $this->get('request_stack'));
    }
    ...
    {
        return $this->services['security.encoder_factory'] = new \Symfony\Component\Security\Core\Encoder\EncoderFactory(array('Sof\\ApiBundle\\Entity\\User' => array('class' => 'Symfony\\Component\\Security\\Core\\Encoder\\MessageDigestPasswordEncoder', 'arguments' => array(0 => 'md5', 1 => false, 2 => 1))));
    }
    protected function getSecurity_FirewallService()
    {
        return $this->services['security.firewall'] = new \Symfony\Component\Security\Http\Firewall(new \Symfony\Bundle\SecurityBundle\Security\FirewallMap($this, array('security.firewall.map.context.dev' => new \Symfony\Component\HttpFoundation\RequestMatcher('^/(_(profiler|wdt)|css|images|js)/'), 'security.firewall.map.context.login' => new \Symfony\Component\HttpFoundation\RequestMatcher('^/(login$|login\\.css$)'), 'security.firewall.map.context.secured_area' => new \Symfony\Component\HttpFoundation\RequestMatcher('^/'))), $this->get('event_dispatcher'));
    }
    ...
    protected function getSecurity_Firewall_Map_Context_SecuredAreaService()
    {
        ...
        $i = new \Symfony\Component\Security\Http\Firewall\LogoutListener($b, $h, new \Symfony\Component\Security\Http\Logout\DefaultLogoutSuccessHandler($h, '/login'), array('csrf_parameter' => '_csrf_token', 'intention' => 'logout', 'logout_path' => '/user_logout'));
        ...
        $j->setOptions(array('use_referer' => true, 'always_use_default_target_path' => true, 'login_path' => '/login', 'default_target_path' => '/Common_Index', 'target_path_parameter' => '_target_path'));
        ...
        return $this->services['security.firewall.map.context.secured_area'] = new \Symfony\Bundle\SecurityBundle\Security\FirewallContext(array(0 => new \Symfony\Component\Security\Http\Firewall\ChannelListener($g, new \Symfony\Component\Security\Http\EntryPoint\RetryAuthenticationEntryPoint(80, 443), $a), 1 => new \Symfony\Component\Security\Http\Firewall\ContextListener($b, array(0 => $this->get('security.user.provider.concrete.user_db')), 'secured_area', $a, $c), 2 => $i, 3 => new \Symfony\Component\Security\Http\Firewall\UsernamePasswordFormAuthenticationListener($b, $f, new \Symfony\Component\Security\Http\Session\SessionAuthenticationStrategy('migrate'), $h, 'secured_area', $j, $k, array('check_path' => '/authenticate', 'username_parameter' => 'login_username', 'password_parameter' => 'login_password', 'use_forward' => false, 'require_previous_session' => true, 'csrf_parameter' => '_csrf_token', 'intention' => 'authenticate', 'post_only' => true), $a, $c, NULL), 4 => new \Symfony\Component\Security\Http\Firewall\AccessListener($b, $this->get('security.access.decision_manager'), $g, $f)), new \Symfony\Component\Security\Http\Firewall\ExceptionListener($b, $this->get('security.authentication.trust_resolver'), $h, 'secured_area', new \Symfony\Component\Security\Http\EntryPoint\FormAuthenticationEntryPoint($e, $h, '/login', false), NULL, NULL, $a));
    }
    ...
    protected function getSof_Twig_SofExtensionService()
    {
        return $this->services['sof.twig.sof_extension'] = new \Sof\ApiBundle\Twig\SofTwigExtension();
    }
    ...
    protected function getTemplating_Helper_LogoutUrlService()
    {
        ...
        $instance->registerListener('secured_area', '/user_logout', 'logout', '_csrf_token', NULL);
        return $instance;
    }
    ...
    protected function getTwigService()
    {
        ...
        $instance->addExtension($this->get('sof.twig.sof_extension'));
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath(($this->targetDirs[3].'/src/Sof/ApiBundle/Resources/views'), 'SofApi');
    ...
    {
        return $this->services['security.user.provider.concrete.user_db'] = new \Symfony\Bridge\Doctrine\Security\User\EntityUserProvider($this->get('doctrine'), 'Sof\\ApiBundle\\Entity\\User', NULL, NULL);
    }
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'kernel.bundles' => array(
                ...
                'SofApiBundle' => 'Sof\\ApiBundle\\SofApiBundle',
                'AbmundiDatabaseCommandsBundle' => 'Abmundi\\DatabaseCommandsBundle\\AbmundiDatabaseCommandsBundle',
            ),
            ...
            'database_port' => 3306,
            'database_name' => 'chincchi_store',
            'database_user' => 'chincchi_user',
            'database_password' => 'admin123',
            'database_host_slave1' => 'localhost',
            'database_port_slave1' => 3306,
            'database_name_slave1' => 'chincchi_store',
            'database_user_slave1' => 'chincchi_user',
            'database_password_slave1' => 'admin123',
            'database_host_log' => 'log',
            'database_port_log' => 3306,
            'database_name_log' => 'log',
            'database_user_log' => 'root',
            'database_password_log' => NULL,
            ...
            'kernel.default_locale' => 'vi_VN.UTF-8',
            ...
            'doctrine.entity_managers' => array(
                'select_only' => 'doctrine.orm.select_only_entity_manager',
            ...
            'doctrine.connections' => array(
                'select_only' => 'doctrine.dbal.select_only_connection',
